      ...
      <div className="max-w-7xl mx-auto">
        ...
        <section className="min-h-[85vh] flex flex-col justify-center items-center text-center px-6 pt-28">
          ...
          <img
            ...
            alt="Dimas Hanson"
            className="w-36 h-36 md:w-44 md:h-44 rounded-full object-cover border-4 border-gray-700 shadow-lg"
          />
        ...
        <section id="skills" className="py-24 bg-[#111] px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-black p-8 rounded-2xl border border-gray-800 hover:-translate-y-2 transition">
